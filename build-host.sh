...
# Wine's private winuser/ntuser declarations used by server_protocol.h are
# intentionally exposed only for Wine's own source builds.
WINE_NATIVE_FLAGS="-I$WINE_SOURCE/include -fms-extensions -D__WINESRC__"
